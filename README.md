<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=112&color=0:0A66C2,100:007BFF&section=header"/>

# Data Scientist, & Machine Learning 

**`🎲SQL`** **`🐧Linux`** **`📊PowerBI`** **`🐍Python`**  **`☁️AWS`** 


<p align="start">
    <a href= "https://www.linkedin.com/in/welington-fonseca/">
        <img
            alt="LINKEDIN"
            title="My Profile"
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=112&color=0:0A66C2,100:007BFF&section=footer"/>
